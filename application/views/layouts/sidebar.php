...
<aside class="main-sidebar sidebar-primary bg-primary elevation-4">
	<!-- Brand Logo -->
	<a href="" class="col-lg-12 brand-link">
		<img src="<?= base_url('asset/template/') ?>dist/img/binarahayu.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
		<span class="col brand-text text-light font-weight-light">SMK Bina Rahayu</span>
	</a>
